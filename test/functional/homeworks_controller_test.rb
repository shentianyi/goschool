...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { content: @homework.content, deadline: @homework.deadline, title: @homework.title, unmark_number: @homework.unmark_number }
    end
  ...
  test "should update homework" do
    put :update, id: @homework, homework: { content: @homework.content, deadline: @homework.deadline, title: @homework.title, unmark_number: @homework.unmark_number }
    assert_redirected_to homework_path(assigns(:homework))
  end
